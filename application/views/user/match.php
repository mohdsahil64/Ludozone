...
if($match->winner!=$user->id && $match->looser!=$user->id){
    ?>
<a href="" class="btn btn-success btn-sm  w-100 fw-bold my-1"  data-bs-toggle="offcanvas" data-bs-target="#winscreenshot"><i class="bi bi-hand-thumbs-up"></i> I Won The Match</a>
...
if($match->winner!=$user->id && $match->looser!=$user->id){
    ?>
<a href="" class="btn btn-danger btn-sm  w-100 fw-bold my-1"  data-bs-toggle="offcanvas" data-bs-target="#losescreenshot"><i class="bi bi-hand-thumbs-down"></i> I Lost The Match</a>

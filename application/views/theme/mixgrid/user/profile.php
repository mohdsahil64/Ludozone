...
<i class="bi bi-pencil-square"></i>
  ...
  <span class="input-group-text btn-dark" id="update-username">Update</span>
</div>
...
?>
<div class="d-flex align-items-center p-3 rounded border border-dark justify-content-between">
<div>
...
<button class="btn btn-dark w-100"><i class="bi bi-fingerprint"></i> Submit KYC For Approval</button>
</div>
</div>
</form>
  <?php
...
<div class="text-center">
<button class="btn btn-dark w-100" id="verify-kyc"><i class="bi bi-send"></i> Send OTP</button>
</div>
</div>
  <?php
}
...
<div class="text-center">
<button class="btn btn-dark w-100" id="verify-kyc-otp"><i class="bi bi-send"></i> Verify OTP</button>
</div>
</div>

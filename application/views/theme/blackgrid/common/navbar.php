...
<div class="offcanvas offcanvas-start"  tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
  <div class="offcanvas-header bg-white text-dark">
    <h3 class="offcanvas-title" id="offcanvasExampleLabel"><img src="<?=base_url('assets/images/'.$this->db->get('system')->row()->brand_logo)?>" alt="" height="40" class="d-inline-block align-text-top">
     <?=$this->db->get('system')->row()->brand_name?></h3>
...
if(isset($user)){
  ?>
<a href="<?=base_url()?>" class="showloading text-decoration-none text-dark">
...
<a href="<?=base_url('user/profile')?>" class="showloading text-decoration-none text-dark">
<div class="text-center d-flex flex-column">
...
<a href="<?=base_url('user/wallet')?>" class="showloading text-decoration-none text-dark">
<div class="text-center d-flex flex-column">
...
<a href="<?=base_url('user/referral')?>" class="showloading text-decoration-none text-dark">
<div class="text-center d-flex flex-column">
...
<a href="<?=base_url('user/history')?>" class="showloading text-decoration-none text-dark">
<div class="text-center d-flex flex-column">
...
?>
<a href="<?=base_url('user/login')?>" class="showloading text-decoration-none text-dark">
<div class="text-center d-flex flex-column">
<div class="fs-1 p-0 m-0"><i class="bi bi-person"></i></div>
<small>Login</small>
</div>
</a>
<a href="<?=base_url('user/signup')?>" class="showloading text-decoration-none text-dark">
<div class="text-center d-flex flex-column">

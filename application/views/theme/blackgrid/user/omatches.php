...
<div class="d-flex justify-content-between align-items-center mx-2">
    <div>
<span class="fw-bold fs-4">Game : <?=$game->game_name?></span>
</div>
<div>
...
<div>
<button class="btn btn-dark btn-sm text-nowrap" id="creategame-btn"><i class="bi bi-dice-6"></i> Create</button>
</div>
</div>
...
<div class="card my-2 border-none">
    <div class="card-header bg-dark text-white d-flex justify-content-between fw-bold" style="font-size:12px;padding:5px">

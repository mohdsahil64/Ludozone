<div class="card mx-2 my-3" id="signupotp" style="display:none">
  ...
  <div class="card-body">
<button class="btn btn-outline-dark btn-sm" id="changenumber-btn"><i class="bi bi-arrow-left-circle"></i> Change Number</button>
...
By Continuing, you agree to our <a href="<?=base_url('user/page/terms')?>" class="text-decoration-none showloading">Legal Terms</a> and you are 18 years or older.
    ...
    <button class="btn w-100 btn-dark my-2" id="verifyotp-btn">VERIFY</button>
...
if($this->db->get('system')->row()->signup_allowed){
  ?>
<a href="#" class="btn w-100 btn-dark my-2" id="signup_btn">Submit</a>
  <?php
}else{
  ?>
<button type="button" class="btn w-100 btn-dark my-2" disabled>Currently Not Taking New Users</button>
  <?php
}
?>
